	...
	echo "<li><ul class='series'>";
						...
						while($row2=mysql_fetch_array($result2))
						{
							...
							$row3=mysql_fetch_array($result3);
								if($start==true)
								{							
									echo "<li class=\"book book_new\" style='z-index=".$row2['issue']."' data-goup='44' data-mid='".$row2[0]."' onClick='ShowPageContainer(this,".$row2[0].",0);' data-size='".$row2['size']."' title=\"".$row1['name'].$row2['issue']."&#10;".$row2[12]."&#10;";
								...
								else
								{
									...
									echo "' data-goup='44'  data-mid='".$row2[0]."' data-size='".$row2['size']."' onClick='ShowPageContainer(this,".$row2[0].",0);' title=\"".$row1['name'].$row2['issue']."&#10;".$row2[12]."&#10;";
									smartTime(strtotime($row2['createtime']));
									echo "上传\"><img src=\"../magazine/".$row2[0]."/small/".$row3[0]."\"></li>";
								}
						}
					...
					while($row1=mysql_fetch_array($result1))
					{
						...
						while($row2=mysql_fetch_array($result2))
						{
							...
							$row3=mysql_fetch_array($result3);
								...
								{
									echo "<li class=\"book book_new\" data-goup='44' style='z-index=".$row2['issue'];
									if($num>=3)
									{
										echo ";margin-left:-110px";
									}
